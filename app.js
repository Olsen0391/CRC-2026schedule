...
const state=JSON.parse(localStorage.getItem('crc2026')||'{"selected":[],"notes":{},"customTimes":{}}');state.customTimes=state.customTimes||{};let day='2026-09-12', view='program', currentId=null;
