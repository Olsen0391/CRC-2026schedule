const sessions=[
{id:'d1-opening',day:'2026-09-12',time:'9:00〜9:15',title:'開会式',room:'第1会場 / Annex Hall 1'},
{id:'d1-keynote',day:'2026-09-12',time:'9:15〜9:45',title:'会議代表講演',room:'第1会場 / Annex Hall 1'},
{id:'d1-poster-paste',day:'2026-09-12',time:'8:30〜10:00',title:'ポスター貼付',room:'ポスター会場 / Room C-1・C-2'},
{id:'d1-poster-view',day:'2026-09-12',time:'10:00〜16:15',title:'ポスター閲覧',room:'ポスター会場 / Room C-1・C-2'},
{id:'d1-sym1',day:'2026-09-12',time:'10:00〜11:30',title:'シンポジウム１：考えるGCP 〜CRC業務はどう変わるのか？〜',room:'第1会場 / Annex Hall 1'},
{id:'d1-talk1',day:'2026-09-12',time:'9:30〜11:30',title:'座談会１：国内で臨床試験や治験のない希少疾患の患者家族の取り組み〜明日への希望を信じて〜',room:'第7会場 / Room I'},
...
{id:'d1-sym2',day:'2026-09-12',time:'10:00〜11:30',title:'シンポジウム２：CRCの専門性と多様性からキャリアを考える',room:'第2会場 / Room A'},
{id:'d1-sym3',day:'2026-09-12',time:'10:00〜11:30',title:'シンポジウム３：臨床試験をめぐる倫理的・法的・社会的課題（ELSI）について考える',room:'第3会場 / Room D'},
{id:'d1-sym4',day:'2026-09-12',time:'10:00〜11:30',title:'シンポジウム４：日本臨床試験学会の挑戦！〜CRCの立場からの期待を踏まえて〜',room:'第4会場 / Room E'},
{id:'d1-sym5',day:'2026-09-12',time:'10:00〜11:30',title:'シンポジウム５：Single IRB時代に向けたIRBの本質と役割の再整理',room:'第5会場 / Room B-1'},
{id:'d1-sym6',day:'2026-09-12',time:'10:00〜11:30',title:'シンポジウム６：グローバルスタンダードを見据えた治験必須記録／管理の標準化〜組織・立場を越えた取り組み〜',room:'第6会場 / Room B-2'},
{id:'d1-seminar1',day:'2026-09-12',time:'11:45〜12:45',title:'共催セミナー1：PhambieLINQを利用した医療DXへの挑戦 ～電子カルテからEDCへのデータ連携・DCTの医療機関負担軽減への挑戦～',room:'第1会場 / Annex Hall 1'},
{id:'d1-seminar2',day:'2026-09-12',time:'11:45〜12:45',title:'共催セミナー2：治験はどう思われている？ 意識調査で見えた患者さんの期待と不安',room:'第2会場 / Room A'},
{id:'d1-seminar3',day:'2026-09-12',time:'11:45〜12:45',title:'共催セミナー3：～試験参加者保護にどう取り組むか～ それぞれの立場（臨床試験を実施する医療機関、臨床試験に参加する患者）から議論する',room:'第3会場 / Room D'},
{id:'d1-seminar4',day:'2026-09-12',time:'11:45〜12:45',title:'共催セミナー4：治験の質向上を目指して：医療機関と依頼者の協働による新たなアプローチ',room:'第4会場 / Room E'},
{id:'d1-seminar5',day:'2026-09-12',time:'11:45〜12:45',title:'共催セミナー5：今こそ正しく理解したい費用透明化とFMV -医療機関と製薬企業が共に創る臨床試験の未来',room:'第5会場 / Room B-1'},
{id:'d1-seminar6',day:'2026-09-12',time:'11:45〜12:45',title:'共催セミナー6：No More Too Much さらなるフェーズへ：医療機関×治験依頼者×CROで進める Too Much 排除',room:'第6会場 / Room B-2'},
{id:'d1-sym7',day:'2026-09-12',time:'13:00〜14:30',title:'シンポジウム７：医学研究をわかりやすく発信するには？〜多様なステークホルダーと共に創るコミュニケーション〜',room:'第2会場 / Room A'},
{id:'d1-talk2',day:'2026-09-12',time:'13:00〜14:30',title:'座談会２：Single IRBに何を期待するのか〜治験依頼者・医療機関・IRBが共有すべき要件と実務の視点〜',room:'第5会場 / Room B-1'},
...
{id:'d1-sym9',day:'2026-09-12',time:'13:00〜14:30',title:'シンポジウム９：論文化で伝承〜過去・現在・未来へ〜 臨床試験専門職による業務研究と論文化を考える',room:'第6会場 / Room B-2'},
...
{id:'d1-special1',day:'2026-09-12',time:'13:00〜14:00',title:'特別講演１：医学研究をわかりやすく発信するには？〜多様なステークホルダーと共に創るコミュニケーション〜',room:'第1会場 / Annex Hall 1'},
{id:'d1-seminar7',day:'2026-09-12',time:'14:45〜15:45',title:'共催セミナー7：止まらない治験は、「対話」から生まれる ～施設と依頼者が描く治験エコシステムの未来～',room:'第1会場 / Annex Hall 1'},
{id:'d1-seminar8',day:'2026-09-12',time:'14:45〜15:45',title:'共催セミナー8：被験者ケアとデータ品質を高める業務プロセスの最適化 ～現役CRCが紐解くボトルネックと明日から実践できる効率化の知見～',room:'第2会場 / Room A'},
{id:'d1-seminar9',day:'2026-09-12',time:'14:45〜15:45',title:'共催セミナー9：Single IRB時代の治験基盤構築に向けて ～医療機関のパラダイムシフト～',room:'第3会場 / Room D'},
{id:'d1-seminar10',day:'2026-09-12',time:'14:45〜15:45',title:'共催セミナー10：－選ばれる治験実施施設へ！ 施設のコミットを支援する、地域ネットワーク・デジタル・専門人材の三位一体型、次世代症例集積の形',room:'第5会場 / Room B-1'},
{id:'d1-seminar11',day:'2026-09-12',time:'14:45〜15:45',title:'共催セミナー11：「配慮して伝える」をデザインする ―AMED社会共創シンポジウム―',room:'第6会場 / Room B-2'},
...
{id:'d2-special2',day:'2026-09-13',time:'9:00〜10:00',title:'特別講演２：臨床試験が患者に歩み寄るということ〜DCTとPPIが交わる地点から〜',room:'第1会場 / Annex Hall 1'},
...
{id:'d2-poster-view-am',day:'2026-09-13',time:'9:00〜10:45',title:'ポスター閲覧',room:'ポスター会場 / Room C-1・C-2'},
{id:'d2-poster-session',day:'2026-09-13',time:'10:45〜11:30',title:'ポスターセッション',room:'ポスター会場 / Room C-1・C-2'},
{id:'d2-seminar12',day:'2026-09-13',time:'11:45〜12:45',title:'共催セミナー12：なぜ今、カルテ連携治験システムが選ばれるのか？ 〜神戸大・愛媛大・倉敷中央病院の事例で解き明かす『TidyMed』の導入効果と未来〜',room:'第1会場 / Annex Hall 1'},
{id:'d2-seminar13',day:'2026-09-13',time:'11:45〜12:45',title:'共催セミナー13：「治験エコシステム業界宣言2025」の実装に向けて -PhRMA/EFPIAの取り組み',room:'第2会場 / Room A'},
{id:'d2-seminar14',day:'2026-09-13',time:'11:45〜12:45',title:'共催セミナー14：リモートデータ入力が拓くCRC業務の新たなあり方 ― リモートデータ入力の実運用から見えた2つのアプローチ ―',room:'第3会場 / Room D'},
{id:'d2-seminar15',day:'2026-09-13',time:'11:45〜12:45',title:'共催セミナー15：治験現場の効率化を加速するために必要な取り組みとは ―日本CTX研究会第3期提言より―',room:'第4会場 / Room E'},
{id:'d2-seminar16',day:'2026-09-13',time:'11:45〜12:45',title:'共催セミナー16：GCP省令改正後の治験文書の管理・授受を考える ―依頼者・IRB・医療機関それぞれの視点から―',room:'第5会場 / Room B-1'},
{id:'d2-seminar17',day:'2026-09-13',time:'11:45〜12:45',title:'共催セミナー17：治験業務の電子化がもたらした変化とは何か ～運用の効率化・標準化の取り組みからsIRB時代を展望する～',room:'第6会場 / Room B-2'},
{id:'d2-sym14',day:'2026-09-13',time:'13:00〜14:30',title:'シンポジウム１４：生成AIを用いた治験DX〜医療機関における生成AIの活用事例と実現へのロードマップ〜',room:'第1会場 / Annex Hall 1'},
...
{id:'d2-poster-view-pm',day:'2026-09-13',time:'11:30〜14:30',title:'ポスター閲覧',room:'ポスター会場 / Room C-1・C-2'},
{id:'d2-poster-remove',day:'2026-09-13',time:'14:30〜15:15',title:'ポスター撤去',room:'ポスター会場 / Room C-1・C-2'},
{id:'d2-close',day:'2026-09-13',time:'15:15〜',title:'表彰式・閉会式',room:'第1会場 / Annex Hall 1'}
];
...
const noteParts=id=>{const n=state.notes[id];return typeof n==='string'?{learned:n,feeling:''}:{learned:n?.learned||'',feeling:n?.feeling||''}};
...
function card(s){const on=state.selected.includes(s.id),note=noteParts(s.id),preview=[note.learned,note.feeling].filter(Boolean).join(' / ');return `<article class="session cat-${category(s)} ${on?'selected':''}" data-id="${s.id}"><div class="check">${on?'✓':''}</div><div class="session-main"><div class="time">${s.time}</div><h3>${esc(s.title)}</h3><div class="room">${esc(s.room)}</div>${preview?`<div class="note-preview">メモ：${esc(preview)}</div>`:''}</div></article>`}
...
function openModal(id){currentId=id;const s=sessions.find(x=>x.id===id),custom=state.customTimes[id]||officialInputs(s),note=noteParts(id);$('#modalTime').textContent=displayTime(s);$('#modalTitle').textContent=s.title;$('#modalRoom').textContent=s.room;$('#learnedInput').value=note.learned;$('#feelingInput').value=note.feeling;$('#customStart').value=custom.start;$('#customEnd').value=custom.end;$('#modal').hidden=false;setTimeout(()=>$('#learnedInput').focus(),50)}
function reportBody(){const mine=ordered(sessions.filter(s=>state.selected.includes(s.id)));const lines=['CRC 2026 in 京都 参加報告メモ','','参加予定・メモ'];mine.forEach((s,i)=>{const note=noteParts(s.id);lines.push('',`${i+1}. ${s.title}`,`日時：2026年${s.day==='2026-09-12'?'9月12日（土）':'9月13日（日）'} ${displayTime(s)}`,`会場：${s.room}`,`【学んだこと】\n${note.learned||'（未記入）'}`,`【その瞬間の感想】\n${note.feeling||'（未記入）'}`)});lines.push('','※プログラムは2026年7月23日時点のPDFをもとにしています。');return lines.join('\n')}
...
$('#closeModal').onclick=()=>$('#modal').hidden=true;$('#modal').onclick=e=>{if(e.target.id==='modal')$('#modal').hidden=true};$('#saveNote').onclick=()=>{const learned=$('#learnedInput').value.trim(),feeling=$('#feelingInput').value.trim(),start=$('#customStart').value,end=$('#customEnd').value;if((start&&!end)||(!start&&end)){alert('開始時刻と終了時刻の両方を入力してください。');return}if(start&&end&&start>=end){alert('終了時刻は開始時刻より後にしてください。');return}if(learned||feeling)state.notes[currentId]={learned,feeling};else delete state.notes[currentId];if(start&&end)state.customTimes[currentId]={start,end};else delete state.customTimes[currentId];save();$('#modal').hidden=true;render()};$('#clearButton').onclick=()=>{state.selected=[];save();render()};
...
let deferred;window.addEventListener('beforeinstallprompt',e=>{e.preventDefault();deferred=e;$('#installButton').hidden=false});$('#installButton').onclick=async()=>{if(deferred){deferred.prompt();deferred=null;$('#installButton').hidden=true}};if('serviceWorker'in navigator){navigator.serviceWorker.register('sw.js').then(reg=>reg.update());navigator.serviceWorker.addEventListener('controllerchange',()=>{if(!window.__crcReloaded){window.__crcReloaded=true;location.reload()}})}render();
